            ...
            <div class="row justify-content-center">
                <div class="col-sm-6">
                    ...
                    <table class="table table-striped table-hover tab">
                        <thead>
                            <tr>
                                <th scope="col">Nom usagé</th>
                                <th scope="col">email</th>
                                <th scope="col">Compte Admin</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            if($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) { ?>
                                    ...
                                    <tr>
                                        <td class="col-4 bg-primary"><?php echo $row["username"]; ?></td>
                                        <td class="col-4"><?php echo $row["email"]; ?></td>
                                        <td class="col-2"><?php if ($row['admin']=='1'){echo 'Oui';}else{echo 'Non';}?></td>

                                    <?php
                                        if($_SESSION["admin"] == 1){ ?>
                                            <td>
                                                <a class='btn btn-outline-dark btn-primary' href='userModifier.php?id=<?php echo $row['id']?>' role='button'><i class='bi bi-pencil-square'></i></a>
                                                <a class='btn btn-outline-dark btn-primary' href='userSupprimer.php?id=<?php echo $row['id']?>' role='button'><i class='bi bi-trash'></i></a>
                                            </td>
                                            <php
                                        }
                                        ?>
